#########################
Shrink Selection Tool
#########################

.. _Shrink Selection Tool:
...
.. figure:: /images/ShrinkSelection_Vertex.gif
   :scale: 60 %   

   Vertex Shrink Selection

Edge Shrink Selection |Icon_Selection_ShrinkSelectEdge|
---------------------------------------------------------------------------------------------
   
.. figure:: /images/ShrinkSelection_Edge.gif
   :scale: 60 %
   
   Edge Shrink Selection

Polygon Shrink Selection |Icon_Selection_ShrinkSelectPolygon|
---------------------------------------------------------------------------------------------
   
.. figure:: /images/ShrinkSelection_Face.gif
   :scale: 60 %
   
   Polygon Shrink Selection

Steps
--------
1. Select vertices, edges or polygons.
2. Select ``Shrink Tool``.